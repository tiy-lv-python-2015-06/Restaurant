"""
Django settings for ironeats project.
...
SECRET_KEY = 'qevj2)7*&78@6jy1=ygaguero3tb9mx#czm509ulu)p9^3tngv'
...
WSGI_APPLICATION = 'ironeats.wsgi.application'
